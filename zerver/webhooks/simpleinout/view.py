...
@webhook_view("SimpleInOut")
@has_request_variables
def api_simpleinout_webhook(
    request: HttpRequest,
    ...
    if user_specified_topic is None and "username" in payload:
        user_specified_topic = re.sub("^[@#]", "", payload["username"])
